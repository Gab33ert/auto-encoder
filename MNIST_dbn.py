...
P, W, in_index, out_index = build(n_cell, size, size,sparsity=0.05, seed=1)    #build network
...
mnist = tf.keras.datasets.mnist                                                #load and normalise data set
...
if answer == "y":
    mode=0#grbm mode
    seconds = time.time()                                                      #layer 1
    iterr_rbm=3000
    epsilon_w=0.002#0.01#rbm rate
    epsilon_b=epsilon_w
    epsilon_c=epsilon_w
    ...
    seconds = time.time()                                                      #layer 2
    iterr_rbm=1000
    epsilon_w=0.004#0.05#rbm rate
    epsilon_b=epsilon_w
    epsilon_c=epsilon_w
    ...
    seconds = time.time()                                                      #layer 3
    iterr_rbm=1000
    epsilon_w=0.0009#0.05#rbm rate
    epsilon_b=epsilon_w
    epsilon_c=epsilon_w
    ...
    print("layer 3")
    print("error", error(x_test,b[2],c[2],w[2]))
    print("time",time.time()-seconds)

    seconds = time.time()                                                      #layer 4
    iterr_rbm=10000
    epsilon_w=0.004#0.001#rbm rate
    epsilon_b=epsilon_w
    epsilon_c=epsilon_w
